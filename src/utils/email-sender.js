...
const transporter = nodemailer.createTransport({
  ...
  secure: process.env.EMAIL_SECURE === "true", // true pour SSL (port 465)
  auth: {
...
/**
 * Envoie un e-mail de validation avec prénom et code
 ...
 * @param {string} name     - Prénom du destinataire
 * @param {string} tempCode - Code de validation
...
<head>
  ...
  <style>
    ...
    .card {
      background: #fff;
      border-left: 4px solid rgb(28, 121, 90);
